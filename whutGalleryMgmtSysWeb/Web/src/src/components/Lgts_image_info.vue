    ...
    <div class="image-info clear">
      ...
      <div class="warp clear">
        <div class="left">
          ...
          <div class="bot-btn">
            <div @click="setLike(imageInfo.id)" :class="{active_btn:imageInfo.if_like}">
              <img :src="imageInfo.if_like?liked:like">
              <span v-if="!imageInfo.if_like">点赞</span><span v-if="imageInfo.if_like">已点赞</span></div>
            <div @click="setCollect(imageInfo.id)" :class="{active_btn:imageInfo.if_collect}">
              <img :src="imageInfo.if_collect?collected:collect">
